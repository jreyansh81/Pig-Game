...
var scores, roundScore, activePlayer, dice1, dice2, previousRoll, gamePlaying;
...
document.querySelector('.btn-roll').addEventListener('click', function() {
	if(gamePlaying) {
		...
		*/
		...
		//3. Update the round score but only if the rolled NO. was NOT a 1 
		if (dice1 !== 1 && dice2 !== 1) {
			//Add score
			roundScore += dice1 + dice2;     //i.e., roundScore = rondScore + dice;
			document.querySelector('#current-' + activePlayer).textContent = roundScore;
		} else {
			//Next player
			nextPlayer();
